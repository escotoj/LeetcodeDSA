...
class RecentCounter {
    constructor() {
      // Initializes the counter with an empty array for storing recent requests.
      this.requests = [];
    }
    ...
    ping(t) {
      ...
      // Removes requests that are outside the time frame [t - 3000, t].
      while (this.requests[0] < t - 3000) {
        this.requests.shift();
      }
  
      // Returns the number of requests within the time frame.
